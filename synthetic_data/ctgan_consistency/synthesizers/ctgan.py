...
from synthetic_data.ctgan_consistency.synthesizers.base import BaseSynthesizer, random_state
...
class CTGAN(BaseSynthesizer):
    ...
    @random_state
    def fit(self, train_data, discrete_columns=(), target_col=None, epochs=None):
            ...
            for id_ in range(steps_per_epoch):
                ...
                for n in range(self._discriminator_steps):
                    ...
                    if consistency_model:
                        cons_pen = self._get_consistency_penalty(
                            real,
                            fake,
                            consistency_metrics,
                            consistency_model,
                        ...
                        loss_d = -(torch.mean(y_real) - torch.mean(y_fake) - cons_pen)
                    else:
